...
public class Cancellations {
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(Cancellations.class);
    job.setJobName("Total Cancellations");
    ...
    job.setMapperClass(CancellationsMapper.class);
    job.setReducerClass(CancellationsReducer.class);
