...
public class NASDelays {
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(NASDelays.class);
    job.setJobName("Total National Airspace System Delays");
    ...
    job.setMapperClass(NASDelaysMapper.class);
    job.setReducerClass(NASDelaysReducer.class);
