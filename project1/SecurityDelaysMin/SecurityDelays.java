...
public class SecurityDelays {
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(SecurityDelays.class);
    job.setJobName("Total Security Delays");
    ...
    job.setMapperClass(SecurityDelaysMapper.class);
    job.setReducerClass(SecurityDelaysReducer.class);
