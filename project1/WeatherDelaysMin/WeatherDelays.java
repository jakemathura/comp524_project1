...
public class WeatherDelays {
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(WeatherDelays.class);
    job.setJobName("Total Weather Delays");
    ...
    job.setMapperClass(WeatherDelaysMapper.class);
    job.setReducerClass(WeatherDelaysReducer.class);
